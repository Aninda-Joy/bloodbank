      ...
      <header className="sticky top-0 bg-white shadow">
        <div className="container flex flex-col sm:flex-row justify-between items-center mx-auto py-4 px-8">
          ...
          <div className="flex mt-4 sm:mt-0">
            ...
            <Link to={"/find-bloods"} className="px-4">
              Find Bloods
            </Link>
          ...
          <div className="flex items-center gap-2">
            <AddBlood />
            <>
              {!localStorage.getItem("u_token") ? (
                <Button
                  onClick={() => {
                    navigate("/login");
                  }}
                  className="border border-teal-500 hover:border-teal-600 bg-white text-gray-800 hover:bg-teal-50"
                  // variant="secondary"
                >
                  Login
                </Button>
        ...
        <div className="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
          <div className="md:flex md:justify-between">
            <div className="mb-6 md:mb-0">
              <a href="https://JOyBiTe.com/" className="flex items-center">
            ...
            <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              ...
              <div>
                ...
                <ul className="text-gray-500 dark:text-gray-400 font-medium">
                  <li className="mb-4">
                    <a
                      href="https://github.com/themesberg/JOyBiTe"
                      className="hover:underline "
                    >
                      Github
                    </a>
          ...
          <div className="sm:flex sm:items-center sm:justify-between">
            <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
              © 2024{" "}
              <a href="https://JOyBiTe.com/" className="hover:underline">
                JOyBiTe™
              </a>
              . All Rights Reserved.
            </span>
